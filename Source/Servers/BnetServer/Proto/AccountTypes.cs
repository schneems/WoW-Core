...
namespace Bgs.Protocol.Account.V1 {
  ...
  public sealed partial class AccountBlob : pb::IMessage<AccountBlob> {
    ...
    private global::Bgs.Protocol.Account.V1.IdentityVerificationStatus identityCheckStatus_ = 0;
    ...
    public override int GetHashCode() {
      ...
      if (IdentityCheckStatus != 0) hash ^= IdentityCheckStatus.GetHashCode();
      return hash;
    }
    ...
    public void MergeFrom(AccountBlob other) {
      ...
      if (other.IdentityCheckStatus != 0) {
  ...
  public sealed partial class PrivacyInfo : pb::IMessage<PrivacyInfo> {
    ...
    private global::Bgs.Protocol.Account.V1.PrivacyInfo.Types.GameInfoPrivacy gameInfoPrivacy_ = 0;
    ...
    public override int GetHashCode() {
      ...
      if (GameInfoPrivacy != 0) hash ^= GameInfoPrivacy.GetHashCode();
      return hash;
    }
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (IsRealIdVisibleForViewFriends != false) {
        output.WriteRawTag(32);
