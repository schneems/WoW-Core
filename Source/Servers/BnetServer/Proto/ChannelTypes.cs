...
namespace Bgs.Protocol.Channel.V1 {
    ...
    static ChannelTypesReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bWJlciLQBAoMQ2hhbm5lbFN0YXRlEhMKC21heF9tZW1iZXJzGAEgASgNEhMK",
            ...
            "KAgSIAoYZGVzdHJveV9vbl9mb3VuZGVyX2xlYXZlGA4gASgIIpsBCgxQcml2",
            "YWN5TGV2ZWwSCAoETk9ORRAAEhYKElBSSVZBQ1lfTEVWRUxfT1BFThABEiwK",
            "KFBSSVZBQ1lfTEVWRUxfT1BFTl9JTlZJVEFUSU9OX0FORF9GUklFTkQQAhIh",
            "Ch1QUklWQUNZX0xFVkVMX09QRU5fSU5WSVRBVElPThADEhgKFFBSSVZBQ1lf",
            "TEVWRUxfQ0xPU0VEEAQiowEKC01lbWJlclN0YXRlEioKCWF0dHJpYnV0ZRgB",
            "IAMoCzIXLmJncy5wcm90b2NvbC5BdHRyaWJ1dGUSEAoEcm9sZRgCIAMoDUIC",
            "EAESEgoKcHJpdmlsZWdlcxgDIAEoBBInCgRpbmZvGAQgASgLMhkuYmdzLnBy",
            "b3RvY29sLkFjY291bnRJbmZvEhkKEURFUFJFQ0FURURfaGlkZGVuGAUgASgI",
            "ImcKBk1lbWJlchIoCghpZGVudGl0eRgBIAEoCzIWLmJncy5wcm90b2NvbC5J",
            "ZGVudGl0eRIzCgVzdGF0ZRgCIAEoCzIkLmJncy5wcm90b2NvbC5jaGFubmVs",
            "LnYxLk1lbWJlclN0YXRlQgJIAmIGcHJvdG8z"));
  ...
  public sealed partial class ListChannelsOptions : pb::IMessage<ListChannelsOptions> {
    ...
    public override int GetHashCode() {
      ...
      hash ^= AttributeFilter.GetHashCode();
  ...
  public sealed partial class ChannelState : pb::IMessage<ChannelState> {
    ...
    private global::Bgs.Protocol.Channel.V1.ChannelState.Types.PrivacyLevel privacyLevel_ = 0;
    ...
    public override int GetHashCode() {
      ...
      if (PrivacyLevel != 0) hash ^= PrivacyLevel.GetHashCode();
      if (Name.Length != 0) hash ^= Name.GetHashCode();
