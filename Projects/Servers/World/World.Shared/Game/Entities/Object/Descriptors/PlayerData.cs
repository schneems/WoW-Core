...
namespace World.Shared.Game.Entities.Object.Descriptors
{
    public class PlayerData : DescriptorBase
    {
        ...
        public DescriptorField VisibleItems                  => base[0x304, 0x39, MirrorFlags.All];
        public DescriptorField PlayerTitle                   => base[0x33D, 0x1, MirrorFlags.All];
        public DescriptorField FakeInebriation               => base[0x33E, 0x1, MirrorFlags.All];
        public DescriptorField VirtualPlayerRealm            => base[0x33F, 0x1, MirrorFlags.All];
        public DescriptorField CurrentSpecID                 => base[0x340, 0x1, MirrorFlags.All];
        public DescriptorField TaxiMountAnimKitID            => base[0x341, 0x1, MirrorFlags.All];
        public DescriptorField AvgItemLevelTotal             => base[0x342, 0x1, MirrorFlags.All];
        public DescriptorField AvgItemLevelEquipped          => base[0x343, 0x1, MirrorFlags.All];
        public DescriptorField CurrentBattlePetBreedQuality  => base[0x344, 0x1, MirrorFlags.All];
        ...
        public DescriptorField OverrideSpellsID              => base[0x998, 0x1, MirrorFlags.Self | MirrorFlags.UrgentSelfOnly];
        ...
        public DescriptorField OverrideZonePVPType           => base[0x99B, 0x1, MirrorFlags.Self | MirrorFlags.UrgentSelfOnly];
