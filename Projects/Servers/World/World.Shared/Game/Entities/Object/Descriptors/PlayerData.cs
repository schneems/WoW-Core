...
namespace World.Shared.Game.Entities.Object.Descriptors
{
    public class PlayerData : DescriptorBase
    {
        ...
        public DescriptorField ExploredZones                 => base[0x809, 0x100, MirrorFlags.Self];
        public DescriptorField RestStateBonusPool            => base[0x909, 0x1, MirrorFlags.Self];
        public DescriptorField ModDamageDonePos              => base[0x90A, 0x7, MirrorFlags.Self];
        public DescriptorField ModDamageDoneNeg              => base[0x911, 0x7, MirrorFlags.Self];
        public DescriptorField ModDamageDonePercent          => base[0x918, 0x7, MirrorFlags.Self];
        public DescriptorField ModHealingDonePos             => base[0x91F, 0x1, MirrorFlags.Self];
        public DescriptorField ModHealingPercent             => base[0x920, 0x1, MirrorFlags.Self];
        public DescriptorField ModHealingDonePercent         => base[0x921, 0x1, MirrorFlags.Self];
        public DescriptorField ModPeriodicHealingDonePercent => base[0x922, 0x1, MirrorFlags.Self];
        public DescriptorField WeaponDmgMultipliers          => base[0x923, 0x3, MirrorFlags.Self];
        public DescriptorField WeaponAtkSpeedMultipliers     => base[0x926, 0x3, MirrorFlags.Self];
        public DescriptorField ModSpellPowerPercent          => base[0x929, 0x1, MirrorFlags.Self];
        public DescriptorField ModResiliencePercent          => base[0x92A, 0x1, MirrorFlags.Self];
        public DescriptorField OverrideSpellPowerByAPPercent => base[0x92B, 0x1, MirrorFlags.Self];
        public DescriptorField OverrideAPBySpellPowerPercent => base[0x92C, 0x1, MirrorFlags.Self];
        public DescriptorField ModTargetResistance           => base[0x92D, 0x1, MirrorFlags.Self];
        public DescriptorField ModTargetPhysicalResistance   => base[0x92E, 0x1, MirrorFlags.Self];
        public DescriptorField LocalFlags                    => base[0x92F, 0x1, MirrorFlags.Self];
        public DescriptorField LifetimeMaxRank               => base[0x930, 0x1, MirrorFlags.Self];
        public DescriptorField SelfResSpell                  => base[0x931, 0x1, MirrorFlags.Self];
        public DescriptorField PvpMedals                     => base[0x932, 0x1, MirrorFlags.Self];
        public DescriptorField BuybackPrice                  => base[0x933, 0xC, MirrorFlags.Self];
        public DescriptorField BuybackTimestamp              => base[0x93F, 0xC, MirrorFlags.Self];
        public DescriptorField YesterdayHonorableKills       => base[0x94B, 0x1, MirrorFlags.Self];
        public DescriptorField LifetimeHonorableKills        => base[0x94C, 0x1, MirrorFlags.Self];
        public DescriptorField WatchedFactionIndex           => base[0x94D, 0x1, MirrorFlags.Self];
        public DescriptorField CombatRatings                 => base[0x94E, 0x20, MirrorFlags.Self];
        public DescriptorField PvpInfo                       => base[0x96E, 0x24, MirrorFlags.Self];
        public DescriptorField MaxLevel                      => base[0x992, 0x1, MirrorFlags.Self];
        public DescriptorField RuneRegen                     => base[0x993, 0x4, MirrorFlags.Self];
        public DescriptorField NoReagentCostMask             => base[0x997, 0x4, MirrorFlags.Self];
        public DescriptorField GlyphSlots                    => base[0x99B, 0x6, MirrorFlags.Self];
        public DescriptorField Glyphs                        => base[0x9A1, 0x6, MirrorFlags.Self];
        public DescriptorField GlyphSlotsEnabled             => base[0x9A7, 0x1, MirrorFlags.Self];
        public DescriptorField PetSpellPower                 => base[0x9A8, 0x1, MirrorFlags.Self];
        public DescriptorField Researching                   => base[0x9A9, 0xA, MirrorFlags.Self];
        public DescriptorField ProfessionSkillLine           => base[0x9B3, 0x2, MirrorFlags.Self];
        public DescriptorField UiHitModifier                 => base[0x9B5, 0x1, MirrorFlags.Self];
        public DescriptorField UiSpellHitModifier            => base[0x9B6, 0x1, MirrorFlags.Self];
        public DescriptorField HomeRealmTimeOffset           => base[0x9B7, 0x1, MirrorFlags.Self];
        public DescriptorField ModPetHaste                   => base[0x9B8, 0x1, MirrorFlags.Self];
        public DescriptorField SummonedBattlePetGUID         => base[0x9B9, 0x4, MirrorFlags.Self];
        public DescriptorField OverrideSpellsID              => base[0x9BD, 0x1, MirrorFlags.Self | MirrorFlags.UrgentSelfOnly];
        public DescriptorField LfgBonusFactionID             => base[0x9BE, 0x1, MirrorFlags.Self];
        public DescriptorField LootSpecID                    => base[0x9BF, 0x1, MirrorFlags.Self];
        public DescriptorField OverrideZonePVPType           => base[0x9C0, 0x1, MirrorFlags.Self | MirrorFlags.UrgentSelfOnly];
        public DescriptorField ItemLevelDelta                => base[0x9C1, 0x1, MirrorFlags.Self];
        public DescriptorField BagSlotFlags                  => base[0x9C2, 0x4, MirrorFlags.Self];
        public DescriptorField BankBagSlotFlags              => base[0x9C6, 0x7, MirrorFlags.Self];
        public DescriptorField InsertItemsLeftToRight        => base[0x9CD, 0x1, MirrorFlags.Self];
        public DescriptorField QuestCompleted                => base[0x9CE, 0x36B, MirrorFlags.Self];

        public static new int End => UnitData.End + 0xD39;
    }
}
