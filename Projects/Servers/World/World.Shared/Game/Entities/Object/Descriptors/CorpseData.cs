...
namespace World.Shared.Game.Entities.Object.Descriptors
{
    class CorpseData : DescriptorBase
    {
        ...
        public DescriptorField DisplayID         => base[0x8, 0x1];
        public DescriptorField Items             => base[0x9, 0x13];
        public DescriptorField SkinID            => base[0x1C, 0x1];
        public DescriptorField FacialHairStyleID => base[0x1D, 0x1];
        public DescriptorField Flags             => base[0x1E, 0x1];
        public DescriptorField DynamicFlags      => base[0x1F, 0x1, MirrorFlags.ViewerDependet];
        public DescriptorField FactionTemplate   => base[0x20, 0x1];
